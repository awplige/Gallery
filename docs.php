...
<div id="welcome-panel" class="welcome-panel">
	<div class="welcome-panel-content">
		<h1>Welcome to Grid Gallery Plugin Docs</h1>
		...
		<p>Now, go to the plugin's menu "Grid Gallery" and click on "Add Grid Gallery" page.</p>
		<p>Using "Add Image" button upload images through media library.</p>
		<p>Set gallery setting like Thumbnail Quality & Size, Coulmns Layout, Hover Effect, Spacing, Custom CSS etc according to you.</p>
